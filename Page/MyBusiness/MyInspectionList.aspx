<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyInspectionList.aspx.cs" Inherits="WeChat.Page.MyBusiness.MyInspectionList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#Ass_a").click(function () {
                ...
                $.ajax({
                    type: "post", //要用post方式                 
                    url: "MyInspectionList.aspx/AssCon",//方法所在页面和方法名
            ...
            $("#FileConsult_a").click(function () {
                ...
                $("#filedecl").click(function () {
                    ...
                    $.ajax({
                        type: "post", //要用post方式                 
                        url: "MyInspectionList.aspx/FileConsult",//方法所在页面和方法名
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: "{'preinspcode':'" + preinspcode + "'}",
                        cache: false,
                ...
                $("#filecheck").click(function () {
                    ...
                    $.ajax({
                        type: "post", //要用post方式                 
                        url: "MyInspectionList.aspx/picfileconsult",//方法所在页面和方法名
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: "{'preinspcode':'" + preinspcode + "'}",
                        cache: false,
            ...
            function loaddata(itemsPerLoad, lastIndex) {
                $.ajax({
                    type: "post", //要用post方式                 
                    url: "MyInspectionList.aspx/BindList",//方法所在页面和方法名
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        function modifySave(preinspcode, modifystr, modifyflag) {
            ...
            $.confirm('请确认是否保存为 <font color=blue>' + modifystr + '</font>?',
                function () {//OK事件
                    $.ajax({
                        type: "post", //要用post方式                 
                        url: "MyInspectionList.aspx/ModifySave",//方法所在页面和方法名
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
...
<body>
   ...
   <%-- <script type='text/javascript' src='//g.alicdn.com/msui/sm/0.6.2/js/sm-extend.min.js' charset='utf-8'></script>--%>
    ...
    <script type='text/javascript'>
        ...
        $.ajax({
            type: "post", //要用post方式                 
            url: "MyInspectionList.aspx/getConf",//方法所在页面和方法名
            contentType: "application/json; charset=utf-8",
            dataType: "json",
