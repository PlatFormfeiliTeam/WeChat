<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscribeList_busi.aspx.cs" Inherits="WeChat.Page.MyBusiness.SubscribeList_busi" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function loadData(pagesize, lastnum) {
            $.ajax({
                url: 'SubscribeList_busi.aspx/QuerySubscribeInfo',
