...
{
    public partial class MyDeclareList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {//不是接单单位，无此权限
                System.Web.HttpContext.Current.Response.Redirect(@"../Login.aspx?openid=" + user.WCOpenID + "&nickname=" + user.WCNickName + "&transferurl=MyDeclareList");
            }
        }
