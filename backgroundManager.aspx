<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backgroundManager.aspx.cs" Inherits="WeChat.backgroundManager" %>
...
<body>
    ...
    <div style="clear:both">
        ...
        <asp:Button ID="Button2" Enabled="false" runat="server" Text="订阅服务" OnClick="Button2_Click" />
            </div>
